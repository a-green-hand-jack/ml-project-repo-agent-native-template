...
代码未再变化。exact-head review 后改变的 guard G1/G2 已在精确目标 `de9aa2e` 的新 disposable
...
| G1 | 2026-07-13 | Claude Code 2.1.207 / Opus 4.8 | `de9aa2e` | PASS | `raw/13-G1-*-de9aa2e.*`; 默认 deny，独立 SKIP session allow | Codex integration owner |
| G2 | 2026-07-13 | Claude Code 2.1.207 / Opus 4.8 | `de9aa2e` | PASS | `raw/13-G2-*-de9aa2e.*`; `env -C memory rm ...` 被 deny，注册表仍存在 | Codex integration owner |
