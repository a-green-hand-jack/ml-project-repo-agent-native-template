...
代码未再变化。exact-head review 后改变的 guard G1/G2 已在精确目标 `492e042` 的新 disposable
...
| G1 | 2026-07-13 | Claude Code 2.1.207 / Opus 4.8 | `492e042` | PASS | `raw/13-G1-*-492e042.*`; 默认 deny，独立 SKIP session allow | Codex integration owner |
| G2 | 2026-07-13 | Claude Code 2.1.207 / Opus 4.8 | `492e042` | PASS | `raw/13-G2-*-492e042.*`; `env -C memory rm ...` 被 deny，注册表仍存在 | Codex integration owner |
