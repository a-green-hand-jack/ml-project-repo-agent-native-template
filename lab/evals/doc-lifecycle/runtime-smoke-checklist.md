...
代码未再变化。exact-head review 后改变的 guard G1/G2 已在精确目标 `8eea18e` 的新 disposable
...
| G1 | 2026-07-13 | Claude Code 2.1.207 / Opus 4.8 | `8eea18e` | PASS | `raw/13-G1-*-8eea18e.*`; raw 自带 exact HEAD、pre/post status/registry，默认 deny，独立 SKIP allow 并记录唯一 probe artifact | Codex integration owner |
| G2 | 2026-07-13 | Claude Code 2.1.207 / Opus 4.8 | `8eea18e` | PASS | `raw/13-G2-*-8eea18e.*`; raw 自带 exact HEAD、pathspec bytes/text/SHA256 与 pre/post clean/registry-preserved，真实 opaque delete 被 deny | Codex integration owner |
