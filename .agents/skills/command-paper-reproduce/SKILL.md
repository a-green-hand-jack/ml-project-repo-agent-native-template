---
name: command-paper-reproduce
description: "Codex adapter for Claude slash command /paper-reproduce - 把 paper claim 映射到代码并找最小可复现路径"
---

# command-paper-reproduce

Codex does not load project `.claude/commands/*.md` files as custom slash commands.
Use this skill when you would have used `/paper-reproduce` in Claude Code.

Canonical source: `.claude/commands/paper-reproduce.md`. Do not edit this adapter by hand; edit the
