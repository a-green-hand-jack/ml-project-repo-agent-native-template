...
| Validators / tools | `scripts/` | 13 | check-agent-harness / check-anatomy-drift / validate-governance / check-same-commit / adopt-existing-repo / check-adoption-integrity / sync-codex-adapters / bump-template-version / template-sync / agent-state / agent-status / agent-mailbox / check-agent-conflicts |
