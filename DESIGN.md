...
| Validators / tools | `scripts/` | 16 | check-agent-harness / check-anatomy-drift / check-provenance-chain / validate-governance / validate-experiment-state / check-same-commit / adopt-existing-repo / check-adoption-integrity / bootstrap-project / sync-codex-adapters / bump-template-version / template-sync / agent-state / agent-status / agent-mailbox / check-agent-conflicts |
