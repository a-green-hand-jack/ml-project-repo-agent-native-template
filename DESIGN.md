...
| Skills | `.claude/skills/` | 10 | worktree-pr-flow / experiment-workflow / artifact-indexing / session-boundary-control / subagent-routing / interactive-plan-doc / anatomy-drift-control / workflow-recipe-harvesting / template-stress-test / adopt-existing-repo |
...
| Validators / tools | `scripts/` | 6 | check-agent-harness / check-anatomy-drift / validate-governance / check-same-commit / adopt-existing-repo / check-adoption-integrity |
