...
| Validators / tools | `scripts/` | 10 | check-agent-harness / check-anatomy-drift / validate-governance / validate-experiment-state / check-same-commit / adopt-existing-repo / check-adoption-integrity / sync-codex-adapters / bump-template-version / template-sync |
